...
?>
    <html>
        <head>
            <title>AutoARTS | RESET PASSWORD</title>
            ...
            <div class="container-fluid text-center" id="banner-signup" style="margin-top:60px;padding-top:60px;">
                ...
                <form method="POST" action="">
                    <div class="form-group" style="display:flex; justify-content:center;">
                        <input class="otpInput" style="font-weight:700;letter-spacing:3px;width:250px;" placeholder="Enter New Password" type="password" minlength="6" maxlength="30" name="new_pass" id="new_pass" required>
                    </div>
                    <div class="form-group" style="display:flex; justify-content:center;">
                        <input class="otpInput" style="font-weight:700;letter-spacing:3px;width:250px;" placeholder="Confirm New Password" type="password" minlength="6" maxlength="30" name="confirm_new_pass" id="confirm_new_pass" required>
                    </div>
